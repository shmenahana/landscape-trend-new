# Fili Property Maintenance - Services Guide
...
- Spring: Wait until ground firms up (late March/early April)
- Fall: Multiple visits often needed as oaks drop late

### 3. Lawn Aeration & Overseeding
...
- Best results when done annually
...
- Best scheduled: Spring or fall (not mid-summer heat)

**Local Soil Challenge:**
NE Ohio clay requires:
- Proper drainage behind walls
- Gravel backfill
- Perforated drain tile
- Compacted base (not just sand)

### 5. Landscape Design & Installation

**Services:**
- Plant selection and placement
- Bed creation and edging
- Mulching
...
1. **89 Five-Star Reviews** - Established local reputation
